...
/**
 * The CredentialService handles logic regarding Credentials. This mainly
 * consists in retrieving or storing Credentials in the DB.
 */
@Service
public class CredentialsService {
	 ...
	 * @return the retrieved Credentials, or null if no Credentials with the passed
	 *         ID could be found in the DB
	 */
	@Transactional
	 ...
	 * @return the retrieved Credentials, or null if no Credentials with the passed
	 *         username could be found in the DB
	 */
	@Transactional
	...
	/**
	 * This method saves an Credentials in the DB. Before saving it, it sets the
	 * Credentials role to DEFAULT, and encrypts the password.
	 * 
	 * @param credentials the Credentials to save into the DB
	 * @return the saved Credentials
	 * @throws DataIntegrityViolationException if an Credentials with the same
	 *                                         username as the passed Credentials
	...
	public void deleteCredentials(String username) {
		Optional<Credentials> result = this.credentialsRepository.findByUserName(username);
		this.credentialsRepository.delete(result.orElse(null));
	}
}
